...
const zr = (e) => new Ai(typeof e == "string" ? e : e + "", void 0, pt), Ce = (e, ...t) => {
...
const { is: Lr, defineProperty: Pr, getOwnPropertyDescriptor: Mr, getOwnPropertyNames: Hr, getOwnPropertySymbols: jr, getPrototypeOf: Fr } = Object, Ue = globalThis, jt = Ue.trustedTypes, Wr = jt ? jt.emptyScript : "", Ur = Ue.reactiveElementPolyfillSupport, ve = (e, t) => e, Ke = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Wr : null;
      break;
...
let Q = class extends HTMLElement {
  ...
  _$ET(t, i) {
    ...
    if (n !== void 0 && r.reflect === !0) {
      const o = (r.converter?.toAttribute !== void 0 ? r.converter : Ke).toAttribute(i, r.type);
  ...
  _$AK(t, i) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const o = r.getPropertyOptions(n), a = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : Ke;
      this._$Em = n;
...
const _t = globalThis, Wt = (e) => e, Le = _t.trustedTypes, Ut = Le ? Le.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ci = "$lit$", B = `lit$${Math.random().toFixed(9).slice(2)}$`, Ti = "?" + B, Vr = `<${Ti}>`, G = document, we = () => G.createComment(""), $e = (e) => e === null || typeof e != "object" && typeof e != "function", gt = Array.isArray, Yr = (e) => gt(e) || typeof e?.[Symbol.iterator] == "function", rt = `[ 	
\f\r]`, pe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Vt = /-->/g, Yt = />/g, j = RegExp(`>|${rt}(?:([^\\s"'>=/]+)(${rt}*=${rt}*(?:[^ 	
...
const qr = (e, t) => {
  ...
  for (let s = 0; s < i; s++) {
    const c = e[s];
    let u, f, h = -1, v = 0;
    for (; v < c.length && (a.lastIndex = v, f = a.exec(c), f !== null); ) v = a.lastIndex, a === pe ? f[1] === "!--" ? a = Vt : f[1] !== void 0 ? a = Yt : f[2] !== void 0 ? (Oi.test(f[2]) && (n = RegExp("</" + f[2], "g")), a = j) : f[3] !== void 0 && (a = j) : a === j ? f[0] === ">" ? (a = n ?? pe, h = -1) : f[1] === void 0 ? h = -2 : (h = a.lastIndex - f[2].length, u = f[1], a = f[3] === void 0 ? j : f[3] === '"' ? qt : Gt) : a === qt || a === Gt ? a = j : a === Vt || a === Yt ? a = pe : (a = j, n = void 0);
    const p = a === j && e[s + 1].startsWith("/>") ? " " : "";
    o += a === pe ? c + Vr : h >= 0 ? (r.push(u), c.slice(0, h) + Ci + c.slice(h) + B + p) : c + B + (h === -2 ? s : p);
  }
...
class se {
  ...
  $(t) {
    const { values: i, _$litType$: r } = t, n = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Se.createElement(Di(r.h, r.h[0]), this.options)), r);
  ...
  _$AC(t) {
    ...
    return i === void 0 && Zt.set(t.strings, i = new Se(t)), i;
  }
  k(t) {
...
const an = { attribute: !0, type: String, converter: Ke, reflect: !1, hasChanged: mt }, sn = (e = an, t, i) => {
...
const { I: ln } = tn, Jt = (e) => e, Xt = () => document.createComment(""), me = (e, t, i) => {
...
const Ki = new Set(ne), In = new Set(Object.keys(ke)), Rn = /* @__PURE__ */ new Set([
  "binary_sensor",
  "button",
  "climate",
  "media_player",
...
function Zi(e, t, i) {
  const r = qi(e), n = ye(Ge(t)), o = typeof i?.translation_key == "string" ? ye(i.translation_key) : "", a = typeof i?.unique_id == "string" ? ye(i.unique_id) : "";
  let s = 0;
...
function $o(e, t, i) {
  return Object.entries(e.entities ?? {}).some(
    ([r, n]) => n?.platform === ce && n.device_id === i && !!t[r] && Qi(e, r)
  );
}
function So(e) {
  const t = /* @__PURE__ */ new Set();
  for (const i of Object.values(e.entities ?? {}))
    i?.platform !== ce || !i.device_id || t.add(i.device_id);
  return t;
}
function ko(e, t, i, r, n, o) {
  let a;
  for (const s of o) {
    const c = Eo(e, t, s, i, r, n);
...
function Do(e) {
  const t = Ge(e), i = t.split("_").filter(Boolean), r = /* @__PURE__ */ new Set();
...
const No = new Set(k.map((e) => e.domain));
class tr {
  constructor() {
  ...
  _registrySignature(t) {
    const i = t.entities;
    return this._registrySource === i ? this._registrySignatureCache : (this._registrySource = i, this._registrySignatureCache = Ro(t), this._registrySignatureCache);
  }
  _stateSignature(t) {
    const i = t.states;
    return this._stateSource === i ? this._stateSignatureCache : (this._stateSource = i, this._stateSignatureCache = Bo(t), this._stateSignatureCache);
  }
}
function Io(e) {
...
function Po(e) {
  ...
  try {
    ...
    return De(t) ? { valid: !0, value: t } : { valid: !1 };
  } catch {
    return { valid: !1 };
  }
}
function Ne(e, t, i, r = e[i]) {
  const n = r;
...
function Zo(e) {
  return l`
    ...
    content: l`
          ...
          ${e.config.icon_theme === "custom" ? l`<div class="advanced-group">${Qo(e)}</div>` : ""}
...
function ra(e) {
  const t = sa(e.sections), i = d(e.hass, "editor.drag_to_reorder");
  return l`
...
function na(e) {
  const t = da(e.activeEntityKeys), i = ua(
    e.overviewEntities,
    t
...
let Ae = class extends te {
  constructor() {
    super(...arguments), this._config = ie({}), this._discoveryCache = new tr(), this._activeEntityKeysCache = /* @__PURE__ */ new WeakMap(), this._translationsChanged = () => {
      ...
      this._updateConfig({ name: Wo(e) || void 0 });
    };
  }
  setConfig(e) {
    this._config = ie(e);
  ...
  _sectionEntityToggle(e, t, i, r) {
    const n = i.has(t.key), o = e !== "memory", a = ka(this._config.entities, t), s = d(this.hass, ya);
    return l`
      <div
  ...
  _actionField(e) {
    const t = this._config[e.key], i = nr(t, e.key), r = Sa(e.key, t, i);
    return l`
  ...
  _updateActionTarget(e, t, i) {
    this._updateActionConfig(e, {
      target: Ko(this._config[e]?.target, t, i)
    });
  }
  _actionDataChanged(e, t) {
    const i = t.target, r = Po(typeof i.value == "string" ? i.value : "");
  ...
  _updateActionConfig(e, t) {
    const i = this._config[e], r = zo(e, { ...i, ...t });
  ...
  _reorderSection(e, t) {
    const i = Fe(this._config.sections, e, t);
  ...
  _updateConfig(e) {
    ...
    Ca(this._config, t) || (this._config = t, this._emitConfigChanged(t));
  }
...
function de(e) {
  ...
  return Re.size >= Pa && Re.clear(), Re.set(e, i), i;
}
const Ma = /* @__PURE__ */ new Set(["error_status", "reconnect_count", "last_reconnect_reason"]), fr = /* @__PURE__ */ new Set([
  "device_status",
  "device_info",
  "protocol_version",
  "product_id",
  ...
  "connection_state",
  "controlunit_name"
]), Ha = /* @__PURE__ */ new Set(["device_status", "connection_state"]), ja = /* @__PURE__ */ new Set(["off", "idle", "standby"]), Fa = /* @__PURE__ */ new Set(["0", "00:00", "00:00:00"]), Wa = /* @__PURE__ */ new Set([
  "0",
  "available",
  "bereit",
  "connected",
  ...
  "ready",
  "verbunden"
]), Ua = /* @__PURE__ */ new Set(["false", "off", "unknown", "unbekannt"]), Va = /* @__PURE__ */ new Set([
  "alarm",
  "alert",
  "error",
  "fault",
...
function wr(e) {
  ...
  if (Qe(t) || br(t))
    return !1;
  const i = Number(t);
  return Number.isFinite(i) ? i !== 0 : Va.has(t) || Ya.some((r) => t.includes(r));
}
const $r = {
  auto: {
...
const as = /* @__PURE__ */ new Set([
  ...
  "trend_values",
  "values"
], ls = /* @__PURE__ */ new Set(["water_flow", "power"]), ds = /* @__PURE__ */ new Set(["down", "decreasing", "falling", "sinkend"]), us = /* @__PURE__ */ new Set(["flat", "neutral", "stable", "gleichbleibend"]), hs = /* @__PURE__ */ new Set(["rising", "steigend", "up", "increasing"]);
class ps {
  get(t, i) {
    const r = fs(t, i);
...
function Er(e, t) {
  ...
  for (const r of e.config.overview_entities) {
    ...
    e.canRender(n, a) && i.push(ms(e, n, o, a));
  }
  return i;
}
function ms(e, t, i, r) {
  const n = C(t, r, e.hass), o = D(e.hass, r), a = _s(t), s = gs(t, r), c = ys(e.hass, r), u = bs(e.hass, r, c);
  return {
    key: t.key,
    definition: t,
    entityId: i,
...
function gs(e, t) {
  ...
  const i = K(t);
  return i !== void 0 && ls.has(e.key) ? i > 0 ? "active" : "idle" : "neutral";
}
function fs(e, t) {
  const i = [
...
function ys(e, t) {
  ...
  return d(e, "overview.delta", { value: `${o}${xs(n)}${a}` });
}
function bs(e, t, i) {
  const r = $s(t) ?? Ss(t);
  if (r)
...
function $i(e) {
  ...
  if (Cr(t))
    return !1;
  const i = Number(t);
  return Number.isFinite(i) ? i !== 0 : ss.some((r) => t.includes(r));
}
function Tr(e) {
...
function Rs(e) {
  const t = Array.isArray(e.state.attributes.source_list) ? e.state.attributes.source_list.map(String) : [], i = typeof e.state.attributes.media_title == "string" && b(e.state.attributes.media_title) || D(e.hass, e.state), r = b(e.state.attributes.source) || b(e.state.state), n = Os(e.state);
  return l`
...
const Ps = "search_weather_location", Ms = [
...
function Gs(e, t) {
  ...
  return i.length ? l`
    <section class="card-section" data-section="weather">
      ...
      ${i}
      ${e.config.show_weather_services ? oc(e, t) : m}
    </section>
  ` : m;
}
function qs(e, t) {
...
function Qs(e) {
  const t = [];
  for (const i of e) {
    const r = Fs.has(i) ? "wellness" : "controls", n = t[t.length - 1];
...
function rc(e, t, i) {
  ...
  if (!Br(e, r))
    return m;
  const { name: n, temp: o, press: a, del: s } = r, c = n.state, u = o.state, f = a.state, h = s.state, v = c && !L(c) ? b(c.state) || d(e.hass, "label.memory", { slot: i }) : d(e.hass, "label.memory", { slot: i }), p = u ? D(e.hass, u) : D(e.hass, f), y = a.entityId ?? o.entityId ?? n.entityId ?? s.entityId, _ = u ? o.definition : a.definition, $ = a.entityId, S = s.entityId, Z = $ ? e.isServiceBusy($, "press") : !1, H = S ? e.isServiceBusy(S, "press") : !1, N = We(
    e,
    a.definition,
    $,
    f,
...
function _c(e, t) {
  return l`
    <div class="support-check ${t.level}" role="listitem">
      <ha-icon icon=${fc(t.level)}></ha-icon>
      <span>${d(e.hass, cc[t.key])}</span>
      <strong>${d(e.hass, lc[t.level])}</strong>
...
`, Sc = [bc, $c, wc, yc];
function kc(e, t, i) {
  const r = i.deviceId ?? t.device_id, n = new Set(t.hide_entities), o = k.filter(
    (_) => !n.has(_.key)
  ), a = o.map(
    (_) => Tc(e, i, _, r)
...
function xc(e = /* @__PURE__ */ new Date()) {
...
function Tc(e, t, i, r) {
  const n = t.entityIds[i.key], o = (n ? [n, e.entities?.[n]] : void 0) ?? Nc(e, r, i), a = o?.[0], s = o?.[1], c = Tt(e, n ?? a);
  return {
    key: i.key,
    domain: i.domain,
    optional: !!i.optional,
...
let M = class extends te {
  constructor() {
    super(...arguments), this._config = ie({}), this._weatherService = Ps, this._weatherForm = { ...Hs }, this._busyActionKeys = /* @__PURE__ */ new Set(), this._discoveryCache = new tr(), this._overviewTiles = new ps(), this._actions = new Ka(), this._serviceCalls = new Ls((e) => {
  ...
  render() {
    ...
    const e = Be("discovery", () => this._discoverEntities()), t = this._entityResolver(e), i = t("water_heating"), r = i.entityId, n = ho(
      this._config.name,
      i.definition,
      i.state,
      this.hass
    ), o = this._sectionRenderContext(t), a = Be(
      "overview-tiles",
  ...
  _renderRadio(e, t) {
    ...
    return !this._canRender(i.definition, n) || !r || !n ? m : Rs({
      hass: this.hass,
      entityId: r,
      state: n,
  ...
  _sectionHasRenderableContent(e, t) {
    switch (e) {
      ...
      case "controls": {
        ...
        return !!(i.entityId && i.state) || this._hasRenderableEntity(t, Lc);
      }
      case "bath":
  ...
  _iconBubbleClass(e, t) {
    return Ga(e, t, this._config.show_icon_animations);
  }
  _headerIconClass(e) {
    const t = qe(e);
    return [
  ...
  async _setNumber(e, t, i) {
    await this._runServiceCall(
      R(e, "set_value"),
      () => Na(this.hass, e, t, i.target.value)
    );
  }
  async _setText(e, t) {
    await this._runServiceCall(
  ...
  _exportSupportPackage(e) {
    const t = this._supportModel(e), i = Ec(t, this._config), r = JSON.stringify(i, null, 2);
    this.dispatchEvent(

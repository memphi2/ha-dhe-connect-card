const Ee = globalThis, at = Ee.ShadowRoot && (Ee.ShadyCSS === void 0 || Ee.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, st = /* @__PURE__ */ Symbol(), Ot = /* @__PURE__ */ new WeakMap();
let ci = class {
  constructor(t, i, r) {
...
}, Dt = at ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
  for (const r of t.cssRules) i += r.cssText;
  return fr(i);
})(e) : e;
const { is: br, defineProperty: wr, getOwnPropertyDescriptor: $r, getOwnPropertyNames: kr, getOwnPropertySymbols: Sr, getPrototypeOf: xr } = Object, Ne = globalThis, Nt = Ne.trustedTypes, Er = Nt ? Nt.emptyScript : "", Ar = Ne.reactiveElementPolyfillSupport, de = (e, t) => e, Ae = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Er : null;
      break;
  ...
  return i;
} }, ct = (e, t) => !br(e, t), It = { attribute: !0, type: String, converter: Ae, reflect: !1, useDefault: !1, hasChanged: ct };
...
let Z = class extends HTMLElement {
  ...
  static createProperty(t, i = It) {
    if (i.state && (i.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((i = Object.create(i)).wrapped = !0), this.elementProperties.set(t, i), !i.noAccessor) {
      ...
      n !== void 0 && wr(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, i, r) {
    const { get: n, set: o } = $r(this.prototype, t) ?? { get() {
      return this[i];
    }, set(a) {
      this[i] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(de("properties"))) {
      const i = this.properties, r = [...kr(i), ...Sr(i)];
  ...
  _$ET(t, i) {
    ...
    if (n !== void 0 && r.reflect === !0) {
      const o = (r.converter?.toAttribute !== void 0 ? r.converter : Ae).toAttribute(i, r.type);
  ...
  _$AK(t, i) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const o = r.getPropertyOptions(n), a = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : Ae;
      this._$Em = n;
  ...
  requestUpdate(t, i, r, n = !1, o) {
    if (t !== void 0) {
      ...
      if (n === !1 && (o = this[t]), r ??= a.getPropertyOptions(t), !((r.hasChanged ?? ct)(o, i) || r.useDefault && r.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(a._$Eu(t, r)))) return;
      this.C(t, i, r);
    }
...
Z.elementStyles = [], Z.shadowRootOptions = { mode: "open" }, Z[de("elementProperties")] = /* @__PURE__ */ new Map(), Z[de("finalized")] = /* @__PURE__ */ new Map(), Ar?.({ ReactiveElement: Z }), (Ne.reactiveElementVersions ??= []).push("2.1.2");
const lt = globalThis, Rt = (e) => e, Ce = lt.trustedTypes, Bt = Ce ? Ce.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, li = "$lit$", R = `lit$${Math.random().toFixed(9).slice(2)}$`, di = "?" + R, Cr = `<${di}>`, F = document, pe = () => F.createComment(""), me = (e) => e === null || typeof e != "object" && typeof e != "function", dt = Array.isArray, Tr = (e) => dt(e) || typeof e?.[Symbol.iterator] == "function", Ve = `[ 	
\f\r]`, ce = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, zt = /-->/g, Lt = />/g, H = RegExp(`>|${Ve}(?:([^\\s"'>=/]+)(${Ve}*=${Ve}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Pt = /'/g, Mt = /"/g, ui = /^(?:script|style|textarea|title)$/i, Or = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), c = Or(1), V = /* @__PURE__ */ Symbol.for("lit-noChange"), h = /* @__PURE__ */ Symbol.for("lit-nothing"), Kt = /* @__PURE__ */ new WeakMap(), W = F.createTreeWalker(F, 129);
function hi(e, t) {
...
const Dr = (e, t) => {
  ...
  let n, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = ce;
  for (let l = 0; l < i; l++) {
    const s = e[l];
    let p, m, u = -1, f = 0;
    for (; f < s.length && (a.lastIndex = f, m = a.exec(s), m !== null); ) f = a.lastIndex, a === ce ? m[1] === "!--" ? a = zt : m[1] !== void 0 ? a = Lt : m[2] !== void 0 ? (ui.test(m[2]) && (n = RegExp("</" + m[2], "g")), a = H) : m[3] !== void 0 && (a = H) : a === H ? m[0] === ">" ? (a = n ?? ce, u = -1) : m[1] === void 0 ? u = -2 : (u = a.lastIndex - m[2].length, p = m[1], a = m[3] === void 0 ? H : m[3] === '"' ? Mt : Pt) : a === Mt || a === Pt ? a = H : a === zt || a === Lt ? a = ce : (a = H, n = void 0);
    const _ = a === H && e[l + 1].startsWith("/>") ? " " : "";
    o += a === ce ? s + Cr : u >= 0 ? (r.push(p), s.slice(0, u) + li + s.slice(u) + R + _) : s + R + (u === -2 ? l : _);
  }
  return [hi(e, o + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class ge {
  constructor({ strings: t, _$litType$: i }, r) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const l = t.length - 1, s = this.parts, [p, m] = Dr(t, i);
    if (this.el = ge.createElement(p, r), W.currentNode = this.el.content, i === 2 || i === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (n = W.nextNode()) !== null && s.length < l; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const u of n.getAttributeNames()) if (u.endsWith(li)) {
          const f = m[a++], _ = n.getAttribute(u).split(R), y = /([.?@])?(.*)/.exec(f);
          s.push({ type: 1, index: o, name: y[2], strings: _, ctor: y[1] === "." ? Ir : y[1] === "?" ? Rr : y[1] === "@" ? Br : Ie }), n.removeAttribute(u);
        } else u.startsWith(R) && (s.push({ type: 6, index: o }), n.removeAttribute(u));
        if (ui.test(n.tagName)) {
          const u = n.textContent.split(R), f = u.length - 1;
          if (f > 0) {
            n.textContent = Ce ? Ce.emptyScript : "";
            for (let _ = 0; _ < f; _++) n.append(u[_], pe()), W.nextNode(), s.push({ type: 2, index: ++o });
            n.append(u[f], pe());
          }
        }
      } else if (n.nodeType === 8) if (n.data === di) s.push({ type: 2, index: o });
      else {
        let u = -1;
        for (; (u = n.data.indexOf(R, u + 1)) !== -1; ) s.push({ type: 7, index: o }), u += R.length - 1;
      }
      o++;
    }
  }
...
function Q(e, t, i = e, r) {
  ...
  return n?.constructor !== o && (n?._$AO?.(!1), o === void 0 ? n = void 0 : (n = new o(e), n._$AT(e, i, r)), r !== void 0 ? (i._$Co ??= [])[r] = n : i._$Cl = n), n !== void 0 && (t = Q(e, n._$AS(e, t.values), n, r)), t;
}
class Nr {
  constructor(t, i) {
  ...
  u(t) {
    ...
    W.currentNode = n;
    let o = W.nextNode(), a = 0, l = 0, s = r[0];
    for (; s !== void 0; ) {
      if (a === s.index) {
        let p;
        s.type === 2 ? p = new ne(o, o.nextSibling, this, t) : s.type === 1 ? p = new s.ctor(o, s.name, s.strings, this, t) : s.type === 6 && (p = new zr(o, this, t)), this._$AV.push(p), s = r[++l];
      }
...
class ne {
  ...
  _$AI(t, i = this) {
    t = Q(this, t, i), me(t) ? t === h || t == null || t === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : t !== this._$AH && t !== V && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Tr(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== h && me(this._$AH) ? this._$AA.nextSibling.data = t : this.T(F.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: i, _$litType$: r } = t, n = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = ge.createElement(hi(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === n) this._$AH.p(i);
    else {
      const o = new Nr(n, this), a = o.u(this.options);
      o.p(i), this.T(a), this._$AH = o;
    }
  }
  _$AC(t) {
    let i = Kt.get(t.strings);
    return i === void 0 && Kt.set(t.strings, i = new ge(t)), i;
  }
  k(t) {
    dt(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let r, n = 0;
    for (const o of t) n === i.length ? i.push(r = new ne(this.O(pe()), this.O(pe()), this, this.options)) : r = i[n], r._$AI(o), n++;
...
class Ie {
  ...
  _$AI(t, i = this, r, n) {
    ...
    let a = !1;
    if (o === void 0) t = Q(this, t, i, 0), a = !me(t) || t !== this._$AH && t !== V, a && (this._$AH = t);
    else {
      const l = t;
      let s, p;
      for (t = o[0], s = 0; s < o.length - 1; s++) p = Q(this, l[r + s], i, s), p === V && (p = this._$AH[s]), a ||= !me(p) || p !== this._$AH[s], p === h ? t = h : t !== h && (t += (p ?? "") + o[s + 1]), this._$AH[s] = p;
    }
    a && !n && this.j(t);
  }
  j(t) {
...
const Lr = { I: ne }, Pr = lt.litHtmlPolyfillSupport;
Pr?.(ge, ne), (lt.litHtmlVersions ??= []).push("3.3.3");
const Mr = (e, t, i) => {
  const r = i?.renderBefore ?? t;
  let n = r._$litPart$;
  if (n === void 0) {
    const o = i?.renderBefore ?? null;
    r._$litPart$ = n = new ne(t.insertBefore(pe(), o), o, void 0, i ?? {});
  }
  return n._$AI(e), n;
};
const ut = globalThis;
let J = class extends Z {
  ...
  update(t) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Mr(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const Kr = ut.litElementPolyfillSupport;
Kr?.({ LitElement: J });
...
const Hr = { attribute: !0, type: String, converter: Ae, reflect: !1, hasChanged: ct }, jr = (e = Hr, t, i) => {
...
function ht(e) {
  return (t, i) => typeof i == "object" ? jr(e, t, i) : ((r, n, o) => {
...
const ee = [
  ...
  ...Y().map(
    (e) => q(`temperature_memory_${e}`, "memory", `Memory ${e}`, pt(e), 200 + e, e > 2)
  ),
  ...Y(3).map(
    (e) => q(
...
].sort((e, t) => e.order - t.order), mi = Object.fromEntries(
  L.map((e) => [e.key, e])
...
const Xr = [
  ...
  "reset_shower_timer"
], fi = ["repair_pairing", "disconnect_radio_pairing"], yi = [
  "state",
  "ha",
  "muted",
  "vivid",
  ...
  "memory",
  "action"
], Qr = new Set(mt), en = /^#(?:[0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/, tn = /^(?:rgb|rgba|hsl|hsla)\([-+0-9.%\s,/]+\)$/i, rn = /^var\(--[a-zA-Z0-9_-]+(?:\s*,\s*(?:#[0-9a-fA-F]{3,8}|[a-zA-Z]+))?\)$/, nn = /^[a-zA-Z]+$/;
function on(e) {
  if (!ln(e))
    return {};
  const t = {};
...
function sn(e) {
  if (typeof e != "string")
    return;
  const t = e.trim();
  if (!(!t || t.includes(";") || t.includes("{") || t.includes("}")) && (en.test(t) || tn.test(t) || rn.test(t) || nn.test(t)))
    return t;
}
function cn(e) {
  return Qr.has(e);
...
const dn = new Set(ee), bi = new Set(Object.keys(mi)), un = /* @__PURE__ */ new Set([
  "binary_sensor",
  "button",
  "climate",
  "media_player",
  ...
  "text",
  "weather"
]), hn = new Set(yi), wi = ["auto", "mini", "tablet", "panel", "kiosk"], $i = ["auto", "compact", "normal", "large"], pn = new Set(wi), mn = new Set($i);
function X(e) {
  const t = et(e) ? e : {};
  return {
    type: "custom:dhe-connect-card",
    device_id: wn(t.device_id),
    name: t.name,
    tap_action: Ye(t.tap_action) ?? { ...Zr },
    hold_action: Ye(t.hold_action),
    double_tap_action: Ye(t.double_tap_action),
    ...
    icon_theme: Wt(t.icon_theme, hn, "state"),
    icon_colors: on(t.icon_colors),
    layout_mode: Wt(t.layout_mode, pn, "auto"),
    tile_size: $n(t.tile_size, t.compact),
    overview_columns: vn(t.overview_columns, 3, 1, 6),
    sections: gn(t.sections),
    overview_entities: _n(t.overview_entities),
    hide_entities: fn(t.hide_entities),
    entities: yn(t.entities)
  };
}
function gn(e) {
  if (!Array.isArray(e) || !e.length)
    return [...ee];
  const t = [
    ...new Set(e.filter((i) => dn.has(i)))
  ];
  return t.length ? t : [...ee];
}
function _n(e) {
  return Array.isArray(e) ? [...new Set(e.filter((t) => bi.has(t)))] : [...Xr];
}
function vn(e, t, i, r) {
  return typeof e != "number" || !Number.isInteger(e) ? t : Math.min(r, Math.max(i, e));
}
function fn(e) {
  return Array.isArray(e) ? [...new Set(e.filter((t) => tt(t)))] : [];
}
function yn(e) {
  if (!et(e))
    return {};
  const t = {};
  for (const [i, r] of Object.entries(e)) {
    if (typeof r == "string" && r.trim() && tt(i)) {
      t[i] = r.trim();
      continue;
    }
    if (!et(r) || !bn(i))
    ...
    for (const [o, a] of Object.entries(r))
      typeof a == "string" && a.trim() && tt(o) && (n[o] = a.trim());
...
function bn(e) {
  return typeof e == "string" && un.has(e);
}
function wn(e) {
...
function it(e) {
  ...
  return {
    ui: Ai(Te(t.ui) ? t.ui : {}),
    entityLabels: Bn(t.entity_labels)
  };
}
function Ai(e, t = "") {
  const i = {};
...
const Pn = /* @__PURE__ */ new Set(["unavailable"]), Ci = /^(?:(?:stiebel(?:\s+eltron)?|stiebel-eltron)\s+)?dhe[\s_-]*connect\b/i, Mn = /^(?:\s*(?:card|integration|durchlauferhitzer|water\s+heater))?(?:\s*[-:–—/|]\s*|\s+|$)/i;
function b(e, t = "") {
  const i = Oe(e);
  if (!i)
    return t.trim();
...
function E(e, t, i) {
  const r = _t(e, i).trim(), n = jn(i, t) ?? t?.attributes.friendly_name, o = b(n, r) || r;
  return On(i) === "de" && Kn(n) && Wn(e, o) ? r : o;
}
function T(e, t) {
  if (!t)
...
const Oi = /* @__PURE__ */ new Set(["unavailable"]), Fn = /* @__PURE__ */ new Set(["heat", "heating", "on"]), Vn = /* @__PURE__ */ new Set(["heating", "preheating"]);
function Be(e) {
...
function P(e) {
  return !e || Oi.has(e.state);
}
function ze(e) {
  if (!e || P(e))
    return !1;
  const t = e.attributes.hvac_action;
  return typeof t == "string" ? Vn.has(t.toLowerCase()) : Fn.has(e.state.toLowerCase());
}
function z(e) {
  if (!(!e || Oi.has(e.state)))
    return Le(e.state);
...
function Ni(e) {
  return [
    ...
    e.label,
    ...e.aliases ?? []
  ].map(ue).filter((t, i, r) => !!t && r.indexOf(t) === i);
}
function Ii(e, t, i) {
  const r = Ni(e), n = ue(Be(t)), o = typeof i?.translation_key == "string" ? ue(i.translation_key) : "", a = typeof i?.unique_id == "string" ? ue(i.unique_id) : "";
  let l = 0;
  return o && r.includes(o) && (l += 80), a && r.some((s) => a === s || a.endsWith(`_${s}`)) && (l += 75), r.some((s) => n === s || n.endsWith(`_${s}`)) && (l += 45), l;
}
function Yn(e, t, i) {
  return Ii(e, t, i) > 0;
}
const Pe = "stiebel_dhe_connect";
function Ri(e, t) {
  const i = new Set(t.hide_entities), n = Jn(
    e,
    Vt(t, "water_heating", "climate"),
    "climate",
    t.device_id
  ) ?? Gn(e, t), o = te(e, n), a = t.device_id ?? o?.device_id ?? void 0, l = n ? Qn(n) : [], s = {};
  for (const m of L) {
    if (i.has(m.key))
      continue;
    const u = Vt(t, m.key, m.domain), f = Bi(e, u, m.domain);
    if (f) {
      s[m.key] = f;
      continue;
    }
  ...
  const p = o?.config_entry_id ?? Object.values(s).map((m) => te(e, m)?.config_entry_id).find((m) => typeof m == "string" && m.length > 0);
  return {
    baseEntity: n,
    configEntryId: p,
    deviceId: a ?? void 0,
...
function Gn(e, t) {
  const i = Object.keys(Me(e)).filter(
    (o) => o.startsWith("climate.") && zi(e, o) && bt(e, o, t.device_id)
  ), r = t.device_id, n = i.find((o) => {
    const a = te(e, o);
    return a?.platform === Pe && (!r || a.device_id === r);
  });
  return n || i.find((o) => {
    const a = Be(o);
...
function qn(e, t, i, r) {
  let n;
  for (const o of Object.keys(Me(e))) {
    if (!o.startsWith(`${t.domain}.`) || !zi(e, o) || !bt(e, o, i))
      continue;
    const a = Zn(e, o, t, i, r);
    a <= 0 || (!n || a > n.score || a === n.score && o < n.entityId) && (n = { entityId: o, score: a });
  }
  return n?.entityId;
}
function Zn(e, t, i, r, n) {
  const o = te(e, t), a = Be(t), l = Ni(i);
  let s = Ii(i, t, o), p = 0;
  o?.platform === Pe && (p += 20), r && o?.device_id === r && (p += 50), n.some(
    (u) => l.some((f) => a === `${u}_${f}`)
  ) && (s += 25);
  const m = Xn(e, t);
  return typeof m == "string" && l.some((u) => ue(m).includes(u)) && (s += 15), s > 0 ? p + s : 0;
}
function te(e, t) {
  if (t)
    return e.entities?.[t];
...
function Bi(e, t, i) {
  if (!(!t || !Me(e)[t]) && !(i && !t.startsWith(`${i}.`)))
    return t;
}
function Jn(e, t, i, r) {
  const n = Bi(e, t, i);
  if (n)
    return bt(e, n, r) ? n : void 0;
}
function bt(e, t, i) {
  if (!i)
    return !0;
...
function Qn(e) {
  const t = Be(e), i = t.split("_").filter(Boolean), r = /* @__PURE__ */ new Set();
...
const eo = new Set(L.map((e) => e.domain));
class Li {
  constructor() {
    this._registrySnapshot = [], this._stateSnapshot = [];
  }
  get(t, i) {
    const r = this._registrySignature(t), n = this._stateSignature(t), o = to(i, r, n);
  ...
  _registrySignature(t) {
    const i = t.entities;
    return this._registrySource === i ? this._registrySnapshot : (this._registrySource = i, this._registrySnapshot = io(t), this._registrySnapshot);
  }
  _stateSignature(t) {
    const i = t.states;
    return this._stateSource === i ? this._stateSnapshot : (this._stateSource = i, this._stateSnapshot = ro(t), this._stateSnapshot);
  }
}
function to(e, t, i) {
...
function io(e) {
  return Object.entries(e.entities ?? {}).filter(([t]) => Pi(t)).map(([t, i]) => [
    t,
    i?.config_entry_id ?? "",
    i?.device_id ?? "",
    i?.disabled_by ?? "",
...
function ro(e) {
  ...
  return Object.entries(t).filter(([i]) => Pi(i)).map(([i, r]) => [
    i,
...
function Ki(e, t) {
  ...
  return i === "perform-action" ? "call-service" : Hi(i) ? i : t === "tap_action" ? "more-info" : "none";
}
function no(e, t) {
  const i = Hi(t.action) ? t.action : Ki(t, e);
  if (i === "none")
    return e === "tap_action" ? { action: i } : void 0;
  const r = { action: i };
  return $e(t, r, "entity"), i === "navigate" && $e(t, r, "navigation_path"), i === "url" && $e(t, r, "url_path"), i === "call-service" && (r.action = "perform-action", $e(t, r, "perform_action", t.service ?? t.perform_action), Gt(t, r, "target"), Gt(t, r, "data")), r;
}
function Yt(e, t) {
  if (!be(e))
    return "";
...
function so(e) {
  ...
  try {
    ...
    return be(t) ? { valid: !0, value: t } : { valid: !1 };
  } catch {
    return { valid: !1 };
  }
}
function $e(e, t, i, r = e[i]) {
  const n = r;
  typeof n == "string" && n.trim() && (t[i] = n.trim());
}
function Gt(e, t, i) {
  const r = e[i];
  be(r) && Object.keys(r).length && (t[i] = { ...r });
}
function co(e) {
  return e.split(/[\n,]/).map((t) => t.trim()).filter(Boolean);
}
function Hi(e) {
  return typeof e == "string" && Mi.includes(e);
}
function be(e) {
  return !!(e && typeof e == "object" && !Array.isArray(e));
}
    ...
    <details class=${i} ?open=${!!t.open}>
      <summary>
        <span class="summary-label">
          ...
          ${t.helpKey ? Wi(e, t.helpKey) : ""}
        </span>
        ${t.count !== void 0 ? c`<small>${t.count}</small>` : t.helpKey ? c`<small>${d(e, t.helpKey)}</small>` : ""}
      </summary>
...
function _o(e) {
  return c`
    ...
    content: c`
          ...
          ${e.config.icon_theme === "custom" ? c`<div class="advanced-group">${wo(e)}</div>` : ""}
...
function So(e, t) {
  ...
  return Ke(
    ...
    t.labelKey,
    i,
    (r) => e.checkboxChanged(t.key, He(r)),
    { helpKey: `${t.labelKey}_help` }
  );
}
const xo = { CHILD: 2 }, Eo = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Ao = class {
  constructor(t) {
  }
  get _$AU() {
...
const { I: Co } = Lr, qt = (e) => e, Zt = () => document.createComment(""), le = (e, t, i) => {
  const r = e._$AA.parentNode, n = t === void 0 ? e._$AB : t._$AA;
  if (i === void 0) {
    const o = r.insertBefore(Zt(), n), a = r.insertBefore(Zt(), n);
    i = new Co(o, a, e, e.options);
  } else {
    ...
    if (o !== n || l) {
      let s = i._$AA;
      for (; s !== o; ) {
        const p = qt(s).nextSibling;
        qt(r).insertBefore(s, n), s = p;
      }
    }
  }
  return i;
}, j = (e, t, i = e) => (e._$AI(t, i), e), To = {}, Oo = (e, t = To) => e._$AH = t, Do = (e) => e._$AH, Ge = (e) => {
...
const Jt = (e, t, i) => {
  ...
  update(e, [t, i, r]) {
    const n = Do(e), { values: o, keys: a } = this.dt(t, i, r);
    if (!Array.isArray(n)) return this.ut = a, o;
    const l = this.ut ??= [], s = [];
    let p, m, u = 0, f = n.length - 1, _ = 0, y = o.length - 1;
    for (; u <= f && _ <= y; ) if (n[u] === null) u++;
    else if (n[f] === null) f--;
    else if (l[u] === a[_]) s[_] = j(n[u], o[_]), u++, _++;
    else if (l[f] === a[y]) s[y] = j(n[f], o[y]), f--, y--;
    else if (l[u] === a[y]) s[y] = j(n[u], o[y]), le(e, s[y + 1], n[u]), u++, y--;
    else if (l[f] === a[_]) s[_] = j(n[f], o[_]), le(e, n[u], n[f]), f--, _++;
    else if (p === void 0 && (p = Jt(a, _, y), m = Jt(l, u, f)), p.has(l[u])) if (p.has(l[f])) {
      const v = m.get(a[_]), k = v !== void 0 ? n[v] : null;
      if (k === null) {
        const O = le(e, n[u]);
        j(O, o[_]), s[_] = O;
      } else s[_] = j(k, o[_]), le(e, n[u], k), n[v] = null;
      _++;
    } else Ge(n[f]), f--;
    else Ge(n[u]), u++;
    for (; _ <= y; ) {
    ...
    return this.ut = a, Oo(e, s), V;
  }
}), Fi = "application/x-dhe-connect-section", Vi = "application/x-dhe-connect-overview-entity";
function No(e) {
  const t = zo(e.sections);
  return c`
...
function Io(e) {
  const t = Mo(e.activeEntityKeys), i = Ko(
    e.overviewEntities,
    t
...
function Qt(e, t, i, r) {
  ...
  return c`
    ...
    _t(t, e.hass),
    n,
    (o) => e.toggleOverviewEntity(t.key, He(o)),
    {
...
function Ji(e, t, i, r, n) {
  ...
  if (o < 0)
    return;
  const a = e.key === "ArrowUp" ? -1 : 1, l = i[o + a];
  l && r(l);
}
function Mo(e) {
...
function Xi(e, t) {
  ...
  if (!i)
    return { config: t };
  const r = Uo(t), n = Vo(e, i), o = Yo(n?.device_id);
  let a = !1;
  return !r.device_id && o && (r.device_id = o), !r.device_id && Fo(e, i, r) && (r.entities = {
    ...r.entities ?? {},
    water_heating: i
  }, a = !0), {
    config: r,
...
function Fo(e, t, i) {
  return er(i) ? !1 : !!(e?.states[t] && t.startsWith("climate."));
}
function er(e) {
  const t = e.entities;
  if (!t)
...
var Go = Object.defineProperty, qo = Object.getOwnPropertyDescriptor, je = (e, t, i, r) => {
  for (var n = r > 1 ? void 0 : r ? qo(t, i) : t, o = e.length - 1, a; o >= 0; o--)
...
let ie = class extends J {
  constructor() {
    super(...arguments), this._config = X({}), this._discoveryCache = new Li(), this._sourceConfig = {}, this._translationsChanged = () => {
      this.requestUpdate();
    }, this._deviceChanged = (e) => {
      const t = Se(e);
      t && this._updateConfig({ device_id: t });
    }, this._nameChanged = (e) => {
      this._updateConfig({ name: ke(e) || void 0 });
  ...
  connectedCallback() {
    super.connectedCallback(), window.addEventListener(_e, this._translationsChanged);
  }
  disconnectedCallback() {
    window.removeEventListener(_e, this._translationsChanged), super.disconnectedCallback();
  }
  willUpdate(e) {
  ...
  _orderingContext(e) {
    return {
      ...
      overviewEntities: e ? Yi(this._config.overview_entities, e) : this._config.overview_entities,
      activeEntityKeys: e,
  ...
  _entityMappingRow(e, t) {
    const i = t.has(e.key), r = Qo(this._config.entities, e);
    return c`
      ...
      _t(e, this.hass),
      !i,
      (n) => this._entityVisibilityChanged(e.key, He(n)),
      {
  ...
  _actionField(e) {
    const t = this._config[e.key], i = Ki(t, e.key), r = Xo(e.key, t, i);
    return c`
  ...
  _checkboxChanged(e, t) {
    if (e === "show_support_mode") {
      this._updateConfig({
        show_support_mode: t,
        sections: tr(this._config.sections, t)
      });
      return;
    }
  ...
  _iconColorChanged(e, t) {
    const i = ke(t), r = { ...this._config.icon_colors };
  ...
  _actionEntityChanged(e, t) {
    this._updateActionConfig(e, { entity: Se(t) });
  }
  ...
  _actionTargetEntityChanged(e, t) {
    this._updateActionTarget(e, "entity_id", Se(t));
  }
  _actionTargetTextChanged(e, t, i) {
    this._updateActionTarget(e, t, ke(i));
  }
  ...
  _actionDataChanged(e, t) {
    const i = t.target, r = so(typeof i.value == "string" ? i.value : "");
  ...
  _updateActionConfig(e, t) {
    const i = this._config[e], r = no(e, { ...i, ...t });
    this._updateConfig({ [e]: r });
  }
  _toggleSection(e, t) {
    this._updateConfig({
      sections: Xt(this._config.sections, e, t)
    });
  }
  _reorderSection(e, t) {
    const i = rt(this._config.sections, e, t);
    this._updateConfig({ sections: i });
  }
  _overviewEntityChanged(e, t) {
    this._updateConfig({
      overview_entities: Xt(
  ...
  _applyConfigMigration(e) {
    const t = Xi(this.hass, this._sourceConfig);
    if (this._legacyMigration = t.legacy, this._config = X(t.config), !t.legacy || (Qi("editor", t.legacy), !e || !t.legacy.resolved))
      return;
...
je([
  oe()
], ie.prototype, "_legacyMigration", 2);
ie = je([
  pi("dhe-connect-card-editor")
], ie);
function Jo(e) {
...
async function ae(e, t, i, r = {}) {
  const n = t.split(".", 1)[0] ?? "";
  return e.callService(n, i, { entity_id: t, ...r });
}
async function ia(e, t, i, r) {
  if (!Number.isFinite(r))
    return;
  const n = $(i, "min_temp") ?? 20, o = $(i, "max_temp") ?? 60, a = $(i, "target_temp_step") ?? 0.5, l = Di(yt(r, n, o), a);
  return ae(e, t, "set_temperature", { temperature: l });
}
...
async function ra(e, t, i, r) {
  ...
  if (n === void 0)
    return;
  const o = $(i, "min"), a = $(i, "max"), l = $(i, "step") ?? 1, s = Di(
    yt(n, o ?? Number.NEGATIVE_INFINITY, a ?? Number.POSITIVE_INFINITY),
    l
  );
  return ae(e, t, "set_value", { value: s });
}
async function na(e, t, i) {
  return ae(e, t, "set_value", { value: i });
}
async function oa(e, t, i) {
  return ae(e, t, "select_option", { option: i });
}
async function aa(e, t, i) {
  ...
  if (r === void 0)
    return;
  const n = yt(r, 0, 1);
  return ae(e, t, "volume_set", { volume_level: n });
}
async function sa(e, t, i, r) {
  const n = {}, o = r ? { entry_id: r, ...i } : i, a = ta[t];
  if (a) {
...
const da = /* @__PURE__ */ new Set(["error_status", "reconnect_count", "last_reconnect_reason"]), ir = /* @__PURE__ */ new Set([
  "device_status",
  "device_info",
  "protocol_version",
  "product_id",
  ...
  "connection_state",
  "controlunit_name"
]), ua = /* @__PURE__ */ new Set(["device_status", "connection_state"]), ha = /* @__PURE__ */ new Set(["off", "idle", "standby"]), pa = /* @__PURE__ */ new Set(["0", "00:00", "00:00:00"]), ma = /* @__PURE__ */ new Set([
  "0",
  "available",
  "bereit",
  "connected",
  ...
  "ready",
  "verbunden"
]), ga = /* @__PURE__ */ new Set(["false", "off", "unknown", "unbekannt"]), _a = /* @__PURE__ */ new Set([
  "alarm",
  "alert",
  "error",
  "fault",
...
function ba(e, t) {
  const i = e.key;
  if (i === "water_heating" && ze(t))
    return "hot";
  if (wt(e))
    return t && nr(t.state) ? "alert" : "ok";
  if ($a(e) && t) {
    if (We(t.state))
      return "ok";
    if (ar(t.state))
  ...
  return i === "outlet_temperature" ? "hot" : wa(e) ? "status" : i.includes("child_safety") || i.includes("scald") || e.icon.includes("shield") ? "safety" : i.includes("wellness") ? "wellness" : i.includes("memory") ? "memory" : i.startsWith("eco_") ? "eco" : i.includes("timer") || i.includes("duration") || i.includes("time") ? "timer" : i.includes("water") || i.includes("bath") || i.includes("flow") || i.includes("temperature") || i === "water_heating" ? "water" : i.includes("energy") || i.includes("power") || i.includes("cost") || i.includes("co2") ? "energy" : i.includes("eco") || i.includes("saving") ? "eco" : e.domain === "weather" || i === "weather_location" ? "weather" : e.domain === "media_player" ? "radio" : e.domain === "button" ? "action" : "water";
}
function wt(e) {
  return da.has(e.key);
}
...
function ka(e) {
  const t = e.key;
  return wt(e) ? "alert" : e.domain === "media_player" ? "radio" : t === "outlet_temperature" || t === "water_heating" ? "heat" : t.includes("bath") ? "water-fill" : t === "water_flow" || t.includes("flow") ? "water-flow" : t.includes("energy") || t.includes("power") || t.includes("cost") ? "energy" : t.includes("timer") || t.includes("duration") || t.includes("time") ? "timer" : t.includes("wellness") ? "wellness" : t.startsWith("eco_") || t.includes("saving") ? "eco" : t.includes("memory") ? "memory" : e.domain === "weather" || t === "weather_location" ? "weather" : t.includes("child_safety") || t.includes("scald") || e.icon.includes("shield") ? "safety" : ir.has(t) ? "status" : "water-flow";
}
function Sa(e, t) {
  return e.domain === "switch" ? ve(t) : e.domain === "media_player" ? rr(t) : e.domain === "button" ? !1 : e.domain === "climate" ? ze(t) : !0;
}
function rr(e) {
  return !ha.has(e.state.toLowerCase());
}
function xa(e, t) {
  ...
  if (e.domain === "weather")
    return !0;
  const i = e.key;
  return i === "water_flow" || i === "power" ? (z(t) ?? 0) > 0 : i === "outlet_temperature" || i === "inlet_temperature" ? z(t) !== void 0 : i.includes("timer") || i.includes("duration") || i.includes("time") ? !pa.has(t.state) : i === "device_status" || i === "connection_state" ? We(t.state) || ar(t.state) : wt(e) ? nr(t.state) : !1;
}
function We(e) {
  const t = $t(e);
  return ma.has(t);
...
function ar(e) {
  ...
  if (We(t) || or(t))
    return !1;
  const i = Number(t);
  return Number.isFinite(i) ? i !== 0 : _a.has(t) || va.some((r) => t.includes(r));
}
function $t(e) {
...
const Oa = /* @__PURE__ */ new Set([
  ...
  "störung",
  "target below inlet"
], Na = /* @__PURE__ */ new Set(["unavailable", "unknown", "unbekannt"]), kt = [
  "delta",
  "change",
  "change_since_last",
  "difference",
  "last_delta"
], St = ["change_percent", "delta_percent", "percentage_delta"], lr = [
  "sparkline",
  "history",
  "samples",
  "trend_values",
...
function dr(e, t) {
  return e.config.overview_entities.map((i) => e.entity(t, i)).filter(({ definition: i, state: r }) => e.canRender(i, r)).map(
    ({ definition: i, entityId: r, state: n }) => Ra(e, i, r, n)
  );
}
function Ra(e, t, i, r) {
  const n = E(t, r, e.hass), o = T(e.hass, r), a = Ba(t), l = za(t, r), s = Pa(e.hass, r), p = Ma(e.hass, r, s);
  return {
    key: t.key,
    definition: t,
    entityId: i,
...
function za(e, t) {
  ...
  if (e.key === "error_status" || e.key.includes("alarm"))
    return ri(t.state) ? "alert" : "ok";
  if (e.key === "device_status" || e.key === "connection_state")
    return ri(t.state) ? "alert" : hr(t.state) ? "ok" : "warning";
  if (e.domain === "switch" || e.domain === "binary_sensor")
...
function La(e, t) {
  const i = e.config.overview_entities.map((r) => {
    ...
    return {
      ...
      trend: Ha(a, ["trend", "trend_direction"]),
      delta: re(a, kt),
      deltaPercent: re(a, St),
      sparkline: ur(a, lr)
    };
  });
  return JSON.stringify({
...
function ur(e, t) {
  if (e)
    for (const i of t) {
      const r = Ua(e.attributes[i]);
      if (r?.length)
        return r;
    }
}
function ja(e) {
  const t = xt(e?.attributes.trend);
  if (t) {
...
function ri(e) {
  ...
  if (hr(t))
    return !1;
  const i = Number(t);
  return Number.isFinite(i) ? i !== 0 : Da.some((r) => t.includes(r));
}
function pr(e) {
...
function Za(e) {
  const t = Array.isArray(e.attributes.source_list) ? e.attributes.source_list.map(String).filter(Boolean) : [], i = Ja(e), r = typeof e.attributes.source == "string" ? e.attributes.source : "", n = t.map((o) => {
    const a = b(o) || o;
    return {
      id: i.find((s) => Xa(s, o, a))?.id,
      label: a,
      source: o,
      active: o === r
    };
  });
  return n.length ? ni(n) : ni(
    i.map((o) => ({
      id: o.id,
      label: o.label,
      source: o.source,
...
function es(e) {
  const t = Array.isArray(e.state.attributes.source_list) ? e.state.attributes.source_list.map(String) : [], i = typeof e.state.attributes.media_title == "string" && b(e.state.attributes.media_title) || T(e.hass, e.state), r = b(e.state.attributes.source) || b(e.state.state), n = Za(e.state);
  return c`
...
const os = "search_weather_location", as = [
...
function ls(e, t) {
  const i = e.entity(t, "water_heating"), r = nt(e, t, Xe), n = nt(e, t, Qe), o = e.config.show_display_buttons ? ot(e, t, Xe, "controls") : r.length ? c`<div class="rows entity-list">${r}</div>` : h, a = e.config.show_display_buttons ? ot(e, t, Qe, "wellness") : n.length ? c`<div class="rows entity-list wellness">${n}</div>` : h, l = i.entityId && i.state ? e.renderClimateControl(i.entityId, i.state) : h;
  return !w(l) && !w(o) && !w(a) ? h : c`
...
function ds(e, t) {
  return gr(e, t, "bath", _i);
}
function us(e, t) {
  return gr(e, t, "timers", vi);
}
function hs(e, t) {
  if (e.config.show_display_buttons)
    return fs(e, t);
  const i = Y().map((r) => bs(e, t, r)).filter(w);
  return i.length ? c`
...
function ps(e, t) {
  ...
  return !e.canRender(i.definition, i.state) && !e.canRender(r.definition, r.state) ? h : c`
    <section class="card-section" data-section="weather">
      ...
      ${fe(e, t, "weather")}
      ${fe(e, t, "weather_location")}
      ${e.config.show_weather_services ? ws(e, t) : h}
    </section>
  `;
}
function ms(e, t) {
  const i = fi.map((r) => fe(e, t, r)).filter(w);
  return i.length ? c`
...
function oi(e, t, i) {
  const r = (Re[i] ?? []).map((n) => fe(e, t, n.key)).filter(w);
  return r.length ? c`
...
function gr(e, t, i, r) {
  return e.config.show_display_buttons ? _s(e, C(i, e.hass), t, r, i) : gs(e, C(i, e.hass), t, r, i);
}
...
function nt(e, t, i) {
  return i.map((r) => fe(e, t, r)).filter(w);
}
function fe(e, t, i) {
  const r = e.entity(t, i);
  if (!e.canRender(r.definition, r.state))
    return h;
  const n = E(r.definition, r.state, e.hass), o = T(e.hass, r.state), a = e.renderRowControl(r.definition, r.entityId, r.state), l = e.isEntityBusy(r.entityId), s = `${n}: ${o}`;
  return c`
...
function ot(e, t, i, r) {
  const n = i.map((o) => vs(e, t, o)).filter(w);
...
function vs(e, t, i) {
  ...
  if (!e.canRender(r.definition, r.state))
    return h;
  const n = E(r.definition, r.state, e.hass), o = T(e.hass, r.state), a = e.renderRowControl(r.definition, r.entityId, r.state), l = r.state ? ve(r.state) : !1, s = e.isEntityBusy(r.entityId), p = `${n}: ${o}`;
  return c`
    <div
      class="display-button-tile ${l ? "active" : ""} ${s ? "busy" : ""}"
...
function fs(e, t) {
  const i = Y().map((r) => ys(e, t, r)).filter(w);
  return i.length ? c`
    <section class="card-section" data-section="memory">
      <h3>${C("memory", e.hass)}</h3>
...
function ys(e, t, i) {
  ...
  if (!vr(e, r))
    return h;
  const { name: n, temp: o, press: a, del: l } = r, s = n.state, p = o.state, m = a.state, u = l.state, f = s && !P(s) ? b(s.state) || d(e.hass, "label.memory", { slot: i }) : d(e.hass, "label.memory", { slot: i }), _ = p ? T(e.hass, p) : T(e.hass, m), y = a.entityId ?? o.entityId ?? n.entityId ?? l.entityId, v = p ? o.definition : a.definition, k = a.entityId, O = l.entityId, Fe = k ? e.isServiceBusy(k, "press") : !1, we = O ? e.isServiceBusy(O, "press") : !1, D = De(
    e,
    a.definition,
    k,
    m,
...
function bs(e, t, i) {
  const { name: r, temp: n, press: o, del: a } = _r(e, t, i), l = r.entityId, s = r.state, p = n.entityId, m = n.state, u = o.entityId, f = o.state, _ = a.entityId, y = a.state;
  if (!vr(e, { name: r, temp: n, press: o, del: a }))
    return h;
  const v = l ? e.isServiceBusy(l, "set_value") : !1, k = p ? e.isServiceBusy(p, "set_value") : !1, O = u ? e.isServiceBusy(u, "press") : !1, Fe = _ ? e.isServiceBusy(_, "press") : !1, we = [l, p, u, _].some(
    (D) => e.isEntityBusy(D)
  );
  return c`
    <div class="memory-row ${we ? "busy" : ""}" aria-busy=${String(we)}>
...
function ws(e, t) {
  const i = e.isActionBusy(mr(e.weatherService));
  return c`
...
function Os(e, t) {
  return c`
    <div class="support-check ${t.level}" role="listitem">
      <ha-icon icon=${Ns(t.level)}></ha-icon>
      <span>${d(e.hass, ks[t.key])}</span>
      <strong>${d(e.hass, Ss[t.level])}</strong>
...
function Ms(e, t, i) {
  const r = t.device_id ?? i.deviceId, n = new Set(t.hide_entities), o = L.filter(
    ...
    (v) => Us(e, i, v, r)
  ), l = a.filter((v) => v.entityIdHash).length, s = a.filter((v) => v.status === "available").length, p = a.filter(
    (v) => ["unavailable", "unknown"].includes(v.status)
  ).length, m = a.filter(
    (v) => !v.optional && v.status === "missing"
  ).length, u = a.filter(
    (v) => v.optional && v.status === "missing"
  ).length, f = r ? At(e, r).filter(
    ...
    diagnostics: {
      cardType: t.type,
      deviceIdHash: he(i.deviceId),
      configEntryIdHash: he(i.configEntryId),
      baseEntityHash: he(i.baseEntity),
      selectedDevice: Ws(e, t, i),
...
function Hs(e = /* @__PURE__ */ new Date()) {
...
function Us(e, t, i, r) {
  const n = t.entityIds[i.key], o = (n ? [n, e.entities?.[n]] : void 0) ?? Ys(e, r, i), a = o?.[0], l = o?.[1], s = ft(e, n ?? a);
  return {
    key: i.key,
    domain: i.domain,
    optional: !!i.optional,
    ...
    registryStatus: qs(l),
    entityIdHash: he(n ?? a),
    registryHash: he(l?.unique_id ?? l?.translation_key)
  };
}
function Fs(e) {
  return [
...
function At(e, t) {
  return Object.entries(e.entities ?? {}).filter(([, i]) => i.platform !== Pe ? !1 : !t || i.device_id === t);
}
function Ys(e, t, i) {
  if (t)
    return At(e, t).find(([r, n]) => r.startsWith(`${i.domain}.`) ? Yn(i, r, n) : !1);
}
function Gs(e) {
...
var Js = Object.defineProperty, Xs = Object.getOwnPropertyDescriptor, se = (e, t, i, r) => {
  for (var n = r > 1 ? void 0 : r ? Xs(t, i) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (n = (r ? a(t, i, n) : a(n)) || n);
  return r && n && Js(t, i, n), n;
};
const Qs = [...Xe, ...Qe];
let K = class extends J {
  ...
  setConfig(e) {
    const t = ai(this._config);
    this._sourceConfig = e, this._applyConfigMigration(), this._supportModelCache = void 0, ai(this._config) !== t && this.requestUpdate();
  }
  getCardSize() {
    return Ea(this._config);
  }
  static getConfigElement() {
    return document.createElement("dhe-connect-card-editor");
  }
  static getStubConfig(e) {
    return { type: "custom:dhe-connect-card", device_id: Ri(e, X({})).deviceId };
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener(_e, this._translationsChanged);
  }
  disconnectedCallback() {
    window.removeEventListener(_e, this._translationsChanged), this._actions.clear(), this._serviceCalls.clear(), this._discoveryCache.clear(), this._overviewTiles.clear(), this._supportModelCache = void 0, super.disconnectedCallback();
  }
  render() {
    if (!this.hass)
      return c`<ha-card class="dhe-card">${d(void 0, "state.loading")}</ha-card>`;
    this._applyConfigMigration();
    const e = xe("discovery", () => this._discoverEntities()), t = this._entityResolver(e), i = t("water_heating"), r = i.entityId, n = Hn(
      this._config.name,
      i.definition,
      i.state,
      this.hass
    ), o = this._sectionRenderContext(t), a = xe(
      "overview-tiles",
      () => this._overviewTiles.get(o, e)
    ), l = xe(
      "section-filter",
      () => this._renderableSections(e, t)
    );
    return c`
      ...
      c`
        ...
        <div
          class="content-grid"
          style=${`--dhe-section-count: ${l.length};`}
        >
          ${M(
      l,
      (s) => s,
  ...
  _cardStyle() {
    const e = [cr(this._config)];
    return this._config.icon_theme === "custom" && e.push(an(this._config.icon_colors)), e.join(" ");
  }
  _applyConfigMigration() {
    const e = Xi(this.hass, this._sourceConfig);
    this._config = X(e.config), e.legacy && Qi("card", e.legacy);
  }
  _renderSection(e, t, i, r) {
    switch (i) {
      ...
      case "diagnostics":
        return this._config.show_diagnostics ? oi(e, t, "diagnostics") : h;
      case "support":
        return this._config.show_support_mode ? xs({
          hass: this.hass,
  ...
  _renderHeaderTemperature(e, t) {
    const i = $(e, "temperature"), r = $(e, "current_temperature"), n = i !== void 0 ? d(this.hass, "label.target", { value: `${i}°` }) : r !== void 0 ? d(this.hass, "label.current", { value: r }) : T(this.hass, e);
    return c`
      ${this._renderActionButton(
      t,
      "temperature entity-action",
  ...
  _renderRadio(e, t) {
    ...
    return !this._canRender(i.definition, n) || !r || !n ? h : es({
      hass: this.hass,
      entityId: r,
      state: n,
  ...
  _renderableSections(e, t) {
    return tr(
      ...
      (i) => this._sectionHasRenderableContent(e, i, t)
    );
  }
  _sectionHasRenderableContent(e, t, i) {
    switch (t) {
      case "overview":
        return this._config.overview_entities.some(
          (r) => this._isEntityRenderable(i, r)
        );
      case "controls": {
        const r = i("water_heating");
        return !!(r.entityId && r.state) || this._hasRenderableEntity(i, Qs);
      }
      case "bath":
        return this._hasRenderableEntity(i, _i);
      case "timers":
        return this._hasRenderableEntity(i, vi);
      case "memory":
        return Y().some(
          (r) => this._hasRenderableEntity(i, [
            `temperature_memory_${r}_name`,
            `temperature_memory_${r}_temperature`,
            `temperature_memory_${r}`,
            `delete_temperature_memory_${r}`
          ])
        );
      case "consumption":
      case "saving":
      case "diagnostics":
        return t === "diagnostics" && !this._config.show_diagnostics ? !1 : (Re[t] ?? []).some(
          (r) => this._isEntityRenderable(i, r.key)
        );
      case "support":
        return this._config.show_support_mode;
      case "weather":
        return this._hasRenderableEntity(i, ["weather", "weather_location"]);
      case "radio":
        return this._isEntityRenderable(i, "radio");
      case "actions":
        return this._hasRenderableEntity(i, fi);
      default:
        return !1;
    }
  }
  ...
  _climateControl(e, t) {
    const i = $(t, "temperature") ?? z(t) ?? 38, r = $(t, "min_temp") ?? 20, n = $(t, "max_temp") ?? 60, o = $(t, "target_temp_step") ?? 0.5, a = this._isServiceBusy(e, "set_temperature"), l = t.state === "off" ? "turn_on" : "turn_off", s = this._isServiceBusy(e, l), p = this._isEntityBusy(e);
    return c`
  ...
  _rowControl(e, t, i) {
    ...
    switch (e.domain) {
      case "switch": {
        const r = ti(i), n = this._isServiceBusy(t, r), o = E(e, i, this.hass);
        return c`
          <button class="chip ${ve(i) ? "active" : ""}" type="button" aria-label=${o} ?disabled=${n} aria-busy=${String(n)} @click=${() => this._toggleSwitch(t, i)}>
            ${ve(i) ? d(this.hass, "button.on") : d(this.hass, "button.off")}
          </button>
        `;
      }
      case "button": {
  ...
  _entity(e, t) {
    const i = mi[t] ?? Wr, r = e.entityIds[t], n = ft(this.hass, r);
  ...
  _iconBubbleClass(e, t) {
    return fa(e, t, this._config.show_icon_animations);
  }
  _headerIconClass(e) {
    const t = ze(e);
    return [
  ...
  _interactionOptions(e) {
    return {
      entityId: e,
      hasDoubleTap: Je(this._config.double_tap_action),
      hasHold: Je(this._config.hold_action),
  ...
  _isServiceBusy(e, t) {
    return this._isActionBusy(I(e, t));
  }
  _isEntityBusy(e) {
  ...
  _supportModel(e) {
    const t = JSON.stringify({
      deviceId: e.deviceId ?? "",
      configEntryId: e.configEntryId ?? "",
      baseEntity: e.baseEntity ?? "",
      entityIds: e.entityIds,
      hideEntities: this._config.hide_entities,
      showDiagnostics: this._config.show_diagnostics,
      statesToken: Ze(this.hass?.states),
      entitiesToken: Ze(this.hass?.entities),
      devicesToken: Ze(this.hass?.devices)
    });
    if (this._supportModelCache?.signature === t)
      return this._supportModelCache.model;
    const i = xe(
      "support-model",
      () => Ms(this.hass, this._config, e)
    );
  ...
  async _setNumber(e, t, i) {
    await this._runServiceCall(
      I(e, "set_value"),
      () => ra(this.hass, e, t, i.target.value)
    );
  }
  async _setText(e, t) {
    await this._runServiceCall(
  ...
  async _setVolume(e, t) {
    await this._runServiceCall(
      I(e, "volume_set"),
      () => aa(this.hass, e, t.target.value)
    );
  }
  async _callWeather(e) {
    await this._runServiceCall(
      mr(this._weatherService),
      () => sa(
        this.hass,
  ...
  _exportSupportPackage(e) {
    const t = this._supportModel(e), i = Ks(t, this._config), r = JSON.stringify(i, null, 2);
    this.dispatchEvent(
...
function Ze(e) {
  if (!e || typeof e != "object")
    return 0;
  const t = e, i = si.get(t);
  if (i !== void 0)
    return i;
  const r = ec++;
  return si.set(t, r), r;
}
window.registerDheConnectCardTranslation = Si;
window.registerDheConnectCardTranslations = xi;
window.dheConnectCardTranslations && xi(window.dheConnectCardTranslations);

import type { DheConnectCardConfig } from "./types";
...
export function actionConfigFromEditor(
  key: ActionConfigKey,
  value: Record<string, unknown>,
): DheConnectCardConfig["tap_action"] | undefined {
  ...
  const config: NonNullable<DheConnectCardConfig["tap_action"]> = { action };
...
function copyStringProperty(
  ...
  target: NonNullable<DheConnectCardConfig["tap_action"]>,
  property: string,

import type { ActionConfig, NormalizedDheConnectCardConfig } from "./types";
...
export function isActionConfigured(action: ActionConfig | undefined): action is ActionConfig {

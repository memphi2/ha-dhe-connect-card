...
The public release line starts at `v0.5.0`. `v0.7.2` is the latest published
stabilization release; `v0.7.3` is the local development line.
...
- [Latest release notes](release-notes/v0.7.3.md)
